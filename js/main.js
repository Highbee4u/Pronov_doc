...
function load_users() {
    document.getElementById("content").innerHTML=
    '<iframe src="users.html#add" style="width:980px; min-height:480px; border:none;" ></iframe>';
}
...
function load_inventory0() {
    document.getElementById("content").innerHTML=
    '<iframe src="inventory.html#add" style="width:980px; min-height:480px; border:none" ></iframe>';
}

function load_inventory() {
    document.getElementById("content").innerHTML=
    '<iframe src="inventory.html#barcode" style="width:980px; min-height:480px; border:none" ></iframe>';
}

function load_inventory1() {
    document.getElementById("content").innerHTML=
    '<iframe src="inventory.html#nobarcode" style="width:980px; min-height:480px; border:none" ></iframe>';
}
function load_inventory2() {
    document.getElementById("content").innerHTML=
    '<iframe src="inventory.html#search" style="width:980px; min-height:480px; border:none" ></iframe>';
}

function load_inventory3() {
    document.getElementById("content").innerHTML=
    '<iframe src="inventory.html#shelve" style="width:980px; min-height:480px; border:none" ></iframe>';
}
